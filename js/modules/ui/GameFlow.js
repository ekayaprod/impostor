...
window.GameApp.UI.GameFlow = (function () {
    ...
    function updateCategoryDisplay() {
        ...
        // Use PlayerManager.numPlayers()
        var numPlayers = 0;
        if (GameApp.UI.PlayerManager && typeof GameApp.UI.PlayerManager.numPlayers === 'function') {
            numPlayers = GameApp.UI.PlayerManager.numPlayers();
        }
